        ...
        <section className="bg-primary text-white px-5 py-32" id="blog">
            <div className="container mx-auto grid md:grid-cols-2 items-center md:justify-between">
                <div className="about-info mb-5">
                    ...
                    <p className="PB-5">Some of my best blog.</p>
                </div>
                <div></div>
            </div>
                ...
                {post.map((item)=>{
                    return (
                        <div>
                            ...
                            <a href={item.url} className="btn bg-accent border-2 border-[#7477FF] text-white px-6 py-6 hover:bg-transparent"> Read More</a>
                        </div>
                    );
                })}
            </div>
