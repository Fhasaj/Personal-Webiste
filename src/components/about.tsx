        ...
        <section className="bg-secondery text-white px-5 py-10" id="about">
            <div className="container mx-auto grid md:grid-cols-2 items-center justify-center md:justify-between">
                ...
                <div className="about-img">
                    <Image
                    className="lgw-[100%] mr-auto"
                    src={AboutImg}
                    alt="coding Something"
                    />
                </div>
        <div className="about-info">
            <h2 className="text-4xl font-bold border-b-[5px] sm:w-10 md:w-64 lg:w-96 xl:w-[620px] border-indigo-600 pb-2">
          ...
          <p>
            <h3 className="text-xl font-semibold mb-5 mt-8 border-b-[5px] sm:w-10 md:w-64 lg:w-96 xl:w-[360px] border-indigo-400 pb-2">
                My Skill Set include but not limted to:
            </h3>
                ...
                <h3 className="text-xl font-semibold mb-5 mt-8 border-b-[5px] sm:w-10 md:w-64 lg:w-96 xl:w-[260px] border-indigo-400 pb-2">
                    Why Choose Me?
                </h3> 
